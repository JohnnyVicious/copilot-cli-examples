...
- **Solution Templates** - Code skeletons with test cases for the languages listed in [language-support](../docs/language-support.md)
...
Choose your preferred language (see [language-support](../docs/language-support.md)), copy the matching solution template, and implement your solution:
